...
<form:form action="/PassportPage/insert" name="Form" method="post" commandName="pp">
    ...
    <br><br><br><br><h1>Passport Registration</h1><br><br><br><br>
        ...
        <fieldset class="Required_details">
            ...
            <div class="Gender">
                    ...
                    <div class="wrapper">
                            <form:radiobutton path="Gender" name="select" id="option-1"/>
                            <form:radiobutton path="Gender" name="select" id="option-2"/>
                ...
                <form:password path="user_password" id="password" name="user_password" Placeholder="Password" onblur="validateForm()"/>
    ...
    <div class="Address_details">
        ...
        <fieldset id="Address" align="left">
          ...
          <form:checkbox path="resident" id="Blind" value="Visibility" name="resident"/><label class="light" for="blind">Visibility</label><br>
           <form:checkbox path="resident" id="Hearing" value="Hearing" name="resident"/><label class="light" for="NRI">Hearing</label><br>
            <br>    
